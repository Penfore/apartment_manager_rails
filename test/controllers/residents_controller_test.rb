...
class ResidentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create resident" do
    assert_difference("Resident.count") do
      post residents_url, params: { resident: { birthday: @resident.birthday, name: @resident.name, owner_id: @resident.owner_id, parentage: @resident.parentage, tenant_id: @resident.tenant_id } }
    end
  ...
  test "should update resident" do
    patch resident_url(@resident), params: { resident: { birthday: @resident.birthday, name: @resident.name, owner_id: @resident.owner_id, parentage: @resident.parentage, tenant_id: @resident.tenant_id } }
