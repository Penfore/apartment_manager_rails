...
class ApartmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create apartment" do
    assert_difference("Apartment.count") do
      post apartments_url, params: { apartment: { block: @apartment.block, number: @apartment.number, owner_id: @apartment.owner_id, rented: @apartment.rented } }
    end
  ...
  test "should update apartment" do
    patch apartment_url(@apartment), params: { apartment: { block: @apartment.block, number: @apartment.number, owner_id: @apartment.owner_id, rented: @apartment.rented } }
