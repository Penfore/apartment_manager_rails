...
class ResidentsTest < ApplicationSystemTestCase
  ...
  test "should create resident" do
    ...
    fill_in "Birthday", with: @resident.birthday
    fill_in "Name", with: @resident.name
    fill_in "Owner", with: @resident.owner_id
    fill_in "Parentage", with: @resident.parentage
    fill_in "Tenant", with: @resident.tenant_id
