class TenantsController < ApplicationController
  ...
  private
    ...
    def tenant_params
      params.require(:tenant).permit(:name, :rg, :birthday, :email, :phone, :authorize_wpp, :moving_date, :company_name, :contact, :end_moving_date, :company_phone, :contact_name, :cnpj)
    end
end
